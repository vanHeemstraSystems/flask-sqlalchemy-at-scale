...
1) Enter `flask_app` directory: `$ cd flask_app`2) 跑步`pip install -r requirements.txt`
3) If non-existent, create a virtual environment inside the `flask_app`目录：`python3 -m venv .venv
