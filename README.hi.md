...
3) Start the virtual environment and enter: `. .venv/bin/सक्रिय करें`4) Set the Flask App to app directory:`(.venv) $ निर्यात FLASK_APP=ऐप`5) Set the Flask Environment to development:`(.venv) $ export FLASK_ENV=development`6) Run the flask app:`(.venv) $ फ्लास्क रन\`\`\`
